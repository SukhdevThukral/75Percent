...
i used ai assitance to the minimal (Claude) during development for hel w react native specifics this was my first react native prokect so i leaned on them similarly to how id use docs or even stack overflow. for ex, adding the name collection step in onboarding, wiring up saveName​/loadName​ with AsyncStorage adn making the home screen dyamniclly pull the user's name instead of having it hardcoded.
...
but regardless of the fact tht ive was trying to imitate the desg ref ive coded the whole UI by myself
